...
chkbox2 = Checkbutton(window, text="badminton",variable=v4)
chkbox3 = Checkbutton(window, text="volleyball",variable=v5)

chkbox.place(x=80, y = 300)
chkbox2.place(x= 220, y = 300)
